...
implementation (currently the Codex and this Python engineering harness). It
defines the shape of a loop `contract`, the mechanical `evidence` a run
produces, the `verdict` derived from grading that evidence, and the
