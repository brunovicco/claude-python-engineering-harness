...
- compatibility problems with the supported Python and Claude Code versions.
...
Review `README.md`, `docs/EVALUATION.md`, `docs/UPGRADING.md`, and generated project documentation
before opening an issue. Usage questions without a reproducible harness problem may be closed or
converted into documentation suggestions.
