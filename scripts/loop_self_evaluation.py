...
class Report:
    ...
    generated_at: str
    harness_repository: str = "claude-python-engineering-harness"
...
def render_and_gate_project(
    ...
    # Unlike the Codex sibling harness, this harness has no per-profile
    # optional "observability" extra (Langfuse tracing is a regular
    # service-profile dependency here, not an opt-in extra), matching
    # .github/workflows/harness-quality.yml's generated-profiles job.
